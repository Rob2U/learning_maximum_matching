...
from environment.commands import (
    PUSH_MARK, PUSH_LEGAL_EDGES, RESET_EDGE_REGISTER, IF_EDGE_WEIGHT_LT,
    WRITE_EDGE_REGISTER, POP_EDGE, IF_EDGE_STACK_REMAINING, ADD_EDGE_TO_SET,
    IF_EDGE_SET_CAPACITY_REMAINING, POP_MARK, JUMP, RET, COMPUTE_MST
)
